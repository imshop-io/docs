...
* **`dataRequired`** - список полей для запроса дополнительных данных\
  ...
  * **`legalEntity`** - возможность добавить юридическое лицо в профиль
...
При регистрации пользователя с юридическим лицом будут приходить такие же данные, как описано в предыдущем абзаце, к ним будет добавлен объект legalEntity, содержащий данный о юридическом лице:
