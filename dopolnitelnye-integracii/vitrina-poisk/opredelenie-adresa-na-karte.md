...
{% hint style="info" %}
Поле является обязательным только, если у клиента должен быть фильтр по магазинам в каталоге, если фильтра нет, то можно не добавлять поле **`deliveryLocation`**в ответ&#x20;
{% endhint %}
