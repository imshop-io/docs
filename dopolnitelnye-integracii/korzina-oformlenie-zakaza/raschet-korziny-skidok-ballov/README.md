...
{% hint style="danger" %}
Доп. поле **`promoGroup`** передаётся в запрос пересчета корзины. Описание формата приведено в разделе [Список "Маркетинговые акции"](spisok-marketingovye-akcii.md#format-zaprosa-posle-vybora-akcii)
{% endhint %}
...
*   **`availablePromocodes`** – доступные промокоды
    ...
    * `backgroundImage` – фоновая картинка на промокоде
    * `appliedImage`  – картинка, которая будет отображена после применения промокода
    * `applyImageAnimation` – тип анимации на применение промокода. Поддерживаются два формата: stamp и fade. По умолчанию fade
    * `backgroundColor` – цвет заливки
    * `textAppearance`  – стиль отображения текста. Поддерживаются два формата: light и dark. По умолчанию dark

    Подробнее в разделе [#karusel-promokodov](./#karusel-promokodov "mention")
...
```json
{
  ...
  "availablePromocodes": [
    {
      "availableUntil": 1735624800,
      "longDescription": "Промокод действует на все товары, кроме товаров по акции. [Не суммируется с баллами](spadream://today) Промокод действует на все товары, кроме товаров по акции. [Не суммируется с баллами](spadream://today)",
      "promocode": "iric16",
      "title": "-20% НА ВСЁ",
      "description": "Доступно до 31 декабря",
      "backgroundImage": "https://chatie.fra1.cdn.digitaloceanspaces.com/test/Orange%20Diagonal%20Voucher%20(1).jpg",
      "appliedImage": "https://chatie.fra1.cdn.digitaloceanspaces.com/test/Orange%20Diagonal%20Voucher%20(2).png",
      "applyImageAnimation": "stamp"
    },
    {
      "availableUntil": 1735624800,
      "description": "Доступно до 31 декабря",
      "longDescription": "Промокод действует на все товары, кроме товаров по акции. Не суммируется с баллами",
      "promocode": "cats",
      "title": "Скидка всем котяткам",
      "backgroundImage": "https://chatie.fra1.cdn.digitaloceanspaces.com/test/New%20Project%20Photopea%20(1).jpg",
      "_appliedImage": "https://chatie.fra1.cdn.digitaloceanspaces.com/test/New%20Project%20Photopea%20(1).png",
      "appliedImage": "https://chatie.fra1.cdn.digitaloceanspaces.com/test/New%20Project%20-%20Photopea.jpg",
      "applyImageAnimation": "fade"
    },
    {
      "availableUntil": 1735624800,
      "description": "Доступно до 31 декабря",
...
<figure><img src="../../../.gitbook/assets/Simulator Screen Recording - iPhone 16 - 2024-12-13 at 16.29.06.gif" alt=""><figcaption></figcaption></figure>
...
| --------------------------------------------------------------- | ------------------------------------------------------------------- |
| ![](<../../../.gitbook/assets/New Project Photopea (1).jpg>)    | ![](<../../../.gitbook/assets/New Project - Photopea.jpg>)          |
| ![](<../../../.gitbook/assets/Orange Diagonal Voucher (1).jpg>) | ![](<../../../.gitbook/assets/Orange Diagonal Voucher (1) (1).png>) |
|                                                                 |                                                                     |
