# Передача наличия и цен по регионам, персональные цены

{% hint style="danger" %}
Если у вас редко (менее 3х раз в день) изменяется подборка товаров в фиде - используйте для передачи наличия и разных цен [**фид наличия для ElasticSearch.**](../fid-nalichiya-dlya-elasticsearch.md)****
{% endhint %}
