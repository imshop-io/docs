...
{% hint style="info" %}
Данный фид создается на стороне клиента (например, с помощью ЗУП). Продадут IMSHOPa передается ссылка на данный фид, загруженный на FTP-сервер, а также логин и пароль для доступа к нему.
{% endhint %}
